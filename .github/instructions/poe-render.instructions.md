...
- ✅ More accurate, context-aware, and semantic understanding of code

# Render Deployment Patterns

## Render Disk Integration
- **Disks are ONLY accessible at runtime, NOT during build** (`https://render.com/docs/disks%23disk-limitations-and-considerations`)
...
- **Must select "Save, rebuild, and deploy"** when adding env vars (`https://render.com/docs/configure-environment-variables`)
...
# From poe-vector.chatmode.md

---
description: 'Poe bot development with Modal deployment best practices'
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'render/*', 'claude-context/*', 'usages', 'vscodeAPI', 'think', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'todos']
---
