...
@app.function(
    ...
    secrets=[
        modal.Secret.from_dict({
            "POE_ACCESS_KEY": "QxXYsepAwwQJg7kIOpTAf0mD9kTpvknZ",
            "POE_BOT_NAME": "LastzAiBeta",
        })
    ],
)
@asgi_app()
def fastapi_app():
    ...
    bot_name_env = os.getenv("POE_BOT_NAME")
    return fp.make_app(
        bot,
        access_key=access_key,
        bot_name=bot_name_env,
        allow_without_key=not (access_key and bot_name_env),
    )
